...
void printNode(node a){
	while(a!=NULL){
		string dem;
		a->sv.firstName = a->sv.fullName.substr(0, a->sv.fullName.find_first_of(" "));
		dem = a->sv.fullName.substr(a->sv.fullName.find_first_of(" "), a->sv.fullName.find_last_of(" "));
		a->sv.lastName = dem.substr(dem.find_last_of(" "), dem.length());
